...
@section('content')
                ...
                <div class="app-main__inner">
                  ...
                  <p style="padding-left: 30px;"><a href="{{route('editfalsePositive',  $item->id)}}"><button type="button" class="btn btn-primary">Edit Reduksi</button></a>
                  </p>
      ...
      color:#2c3e50; font-size :16px; margin-left: 80px; margin-right: 60px;">
                        <dl class="row"> <dt class="col-sm-3" >Model pembelajaran untuk mengatasi False Positiv</dt> <dd class="col-sm-9"> {{$item->model_reduksifalsePositive}}
