...
<div class="container">
  ...
  background: #014362;
  color: white;
  font-size: 30px;">Panduan Siswa</div>
                <div class="card-body">
                    <form  method="POST" enctype="multipart/form-data" class="register-form" action="{{ route('usersiswaStore') }}"> 
                    @csrf
                    <!-- untuk guru = 0 -->
                    <input type="hidden" name="isfor" value="1"> 
