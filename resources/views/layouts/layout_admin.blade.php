        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelola Data Dosen</h6>
                        <a class="collapse-item" href="{{route('userguruCreate')}}">Tambah Data Dosen</a>
                        <a class="collapse-item" href="{{route('userguruData')}}">Daftar Dosen</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelola Data Mahasiswa</h6>
                        <a class="collapse-item" href="{{route('usersiswaCreate')}}">Tambah Data Mahasiswa</a>
                        <a class="collapse-item" href="{{route('usersiswaData')}}">Daftar Data Mahasiswa</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="font-style: italic;">{{auth()->user()->name}} </p></span>
