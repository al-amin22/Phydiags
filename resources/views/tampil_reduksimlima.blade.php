...
@section('content')
                  ...
                  <p style="padding-left: 30px;">
                    <a href="{{route('createmlima')}}"><button type="button" class="btn btn-primary">Tambah Reduksi</button></a>
                  </p>
     
     			@foreach($tampilReduksimlima as $item)

                <div class="app-main__inner">

                  <p style="padding-left: 30px;">
                  <a href="{{route('editmlima',  $item->id)}}"><button type="button" class="btn btn-primary">Edit Reduksi</button></a>
                </p>
