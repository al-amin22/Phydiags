                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption" id="panduan">
                                    ...
                                    berguna dalam mengidentifikasi profil konsepsi mahasiswa.
                                    </p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                <h3>Soal Four-Tier Test</h3>
                                <p>Soal berisikan Pemahaman konsep pada materi fisika</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8">
            ...
            <div class="support-wrapper align-items-center">
                <div class="left-content1">
                    ...
                    <div class="section-tittle section-tittle2 mb-55" >
                        <div class="front-text">
                            ...
                            <p>Four-Tier Test  merupakan tes diagnostik dengan empat tingkat pilihan. Four Tier Test ini merupakan pengembangan dari tes diagnostik pilihan ganda tiga tingkat, yaitu dengan menambah tingkat keyakinan pada masing-masing jawaban dan 
                                alasan. Penambahan tingkat keyakinan pada masing-masing jawaban dan alasan dapat mengukur perbedaan tingkat pengetahuan mahasiswa sehingga akan membantu dalam mendeteksi tingkat miskonsepsi mahasiswa. 
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="single-features">
                        ...
                        <div class="features-caption">
                            <p>Tingkat ke dua merupakan tingkat keyakinan mahasiswa dalam memilih jawaban</p>
                        </div>
                    </div>
                    ...
                    <div class="single-features">
                        ...
                        <div class="features-caption">
                            <p>Tingkat ke tiga merupakan alasan mahasiswa menjawab pertanyaan.</p>
                        </div>
                    </div>
                    <div class="single-features">
                        <div class="features-icon">
                        ...
                        <div class="features-caption">
                            <p>Tingkat ke empat merupakan tingkat keyakinan mahasiswa dalam memilih alasan.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="support-wrapper align-items-center">
                ...
                <div class="left-content3">
                    ...
                    <div class="single-features">
                        ...
                        <div class="features-caption">
                            <p>Mengidentifikasi masalah atau kesulitan yang dialami mahasiswa
                                dengan cepat karna soal four-tier test dirancang dalam website 
                                    yang dapat menganalisis jawaban mahasiswa tersebut dengan cepat</p>
                        </div>
                    </div>
                    <div class="single-features">
                        <div class="features-icon">
                        ...
                        <div class="features-caption">
                            <p>Mahasiswa dapat mengetahui dimana titik kelemahan pemahaman 
