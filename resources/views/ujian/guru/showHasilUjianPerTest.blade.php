...
<div class="container">
  ...
  text-align: center;
  color: white;
  font-size: 30px;">Detail Hasil Test {{$peserta_ujian->siswa->nama_lengkap}}</div>
                <div class="card-body">
            ...
            <a href="{{route('showHasilUjianPersiswa',['ujian_id'=> $peserta_ujian->ujian_id, 'anggota_kelas_id' => $peserta_ujian->anggota_kelas_id])}}"><button class="btn btn-warning" style="box-shadow: 3px 2px 5px grey;"><i class="fa fa-reply mr-1" ></i> Kembali</button></a>
        ...
        <div class="col-md-4">
            <div class="alert alert-success" role="alert">
                ...
                <table class="table table-sm table-hover">
                    <tr><td><li>Scientific Conception (SC) </li></td><td>:</td><td> <?php echo $sc?> </td></tr>
                    <tr><td><li>False Positive (FP) </li></td><td>:</td><td> <?php echo $fp?> </td></tr>
                    <tr><td><li>Lack of Knowledge (LK)</li></td><td>:</td><td> <?php echo $lk?> </td></tr>
                    <tr><td><li>False Negative (FN) </li></td><td>:</td><td> <?php echo $fn?> </td></tr>
                    <tr><td><li>Misconception (MSC) </li></td><td>:</td><td> <?php echo $msc?> </td></tr>
                </table>
                <hr>
