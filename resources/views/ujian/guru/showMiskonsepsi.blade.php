...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-primary" role="alert" style="background: #456bd8;">
                <h5 class="alert-heading mb-0"><strong style="color: white;">{{$miskonsepsi->jenis}} ({{$miskonsepsi->deskripsi}})</strong></h5>
            </div>
        </div>
    </div>
    <div class="row">
  ...
  text-align: center;
  color: white;
  font-size: 30px;">Jawaban Miskonsepsi {{$miskonsepsi->jenis}} </div>
                <div class="card-body">
