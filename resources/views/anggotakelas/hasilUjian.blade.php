            ...
            <table class="table table-striped table-bordered table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@if($item->jawaban_tk1->jawaban == $item->jawaban_tk1->soal_tk1->kunci) 1 @elseif($item->jawaban_tk1->jawaban == "E") jawaban kosong @else 0 @endif</td>
                        <td>@if($item->jawaban_tk2->jawaban == $item->jawaban_tk2->soal_tk2->kunci) 1 @elseif($item->jawaban_tk2->jawaban == "E") jawaban kosong @else 0 @endif</td>
                        <td>@if($item->jawaban_tk3->jawaban == $item->jawaban_tk3->soal_tk3->kunci) 1 @elseif($item->jawaban_tk3->jawaban == "E") jawaban kosong @else 0 @endif</td>
                        <td>@if($item->jawaban_tk4->jawaban == $item->jawaban_tk4->soal_tk4->kunci) 1 @elseif($item->jawaban_tk4->jawaban == "E") jawaban kosong @else 0 @endif</td>
                        <td>
                              {{$item->hasil}}
                        </td>
                        <td> 
...
<a href="{{route('UjianUlangSiswa',$item->id)}}"><button class="btn btn-warning" style="box-shadow: 3px 2px 5px grey;"><i class="fa fa-reply mr-1" ></i> Test Ulang</button></a> 
