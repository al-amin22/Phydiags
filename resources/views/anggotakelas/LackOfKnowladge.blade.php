...
face: "Times New Roman";
   ...
   text-align: left;
      ...
      color:#2c3e50; font-size :16px; margin-left: 80px; margin-right: 60px;">
                        <dl class="row"> <dt class="col-sm-3" >Model pembelajaran untuk mengatasi Lack Of Knowladge</dt> <dd class="col-sm-9"> {{$item->model_reduksilk}}
      ...
      color:#2c3e50; font-size :16px; margin-left: 80px; margin-right: 60px;">
                    ...
                    <div class="container-fluid col-sm-12">
                      <div class="row align-items-start">
                          <div class="col">
                            <p class="dua" style="padding-left: 90px">
                              {!!$item->text_reduksilk!!}
                            </p>
                          </div>
                        </div>
