                    ...
                    if ($jawaban_tk4_kode == 1) {
                        foreach ($semua_soal_satuan as  $item) {
                            if ($semua_soal_satuan[0]['id'] == $request->soal_satuan_id) {
                                if ($jawaban_tk1->jawaban == 'D' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'C' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 1;
                                    //M1
                                ...
                                if ($jawaban_tk1->jawaban == 'A' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'D' && $jawaban_tk4->jawaban == 'A') {
                                    ...
                                    $miskonsepsi_id = 3;
                                    //M3
                                }elseif ($jawaban_tk1->jawaban == 'C' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'C' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 3;
                                    //M3
                                }
                            }elseif ($semua_soal_satuan[2]['id'] == $request->soal_satuan_id) {
                                if ($jawaban_tk1->jawaban == 'B' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'B' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 4;
                                    //M4
                                ...
                                if ($jawaban_tk1->jawaban == 'C' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'B' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 4;
                                    //M4
           
                                }elseif ($jawaban_tk1->jawaban == 'D' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'D' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 6;
                                    //M6
                                }
                                ...
                                if ($jawaban_tk1->jawaban == 'A' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'B' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 3;
                                    //M3
                                }elseif ($jawaban_tk1->jawaban == 'B' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'C' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 3;
                                    //M3
